  ...
  <footer className='bg-gray-900 md:px-36 text-left w-full mt-10 '>
    ...
    justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
      ...
      <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem ipsum dolor, sit amet consectetur adipisicing elit.
         Ipsum itaque ab perferendis
          placeat, nostrum corrupti.</p>
      </div>
      ...
      <div className='hidden md:flex flex-col items-start w-full '>
        ...
        <p className='text:sm text-white/80'>The latest news , articles sent to your inbox weekly</p>
        <div className='flex items-center pt-4 gap-2'>
          ...
          <button className='bg-green-700 cursor-pointer w-24 h-9 text-white rounded'>Subscribe</button>
        </div>
        </div> 
    </div>
      <p className='py-4 md:text-sm text-white/60 text-center text-xs '>Copyright 2025 &copy; Swanand All Rights Reserved.</p>
  </footer>
  )
}
