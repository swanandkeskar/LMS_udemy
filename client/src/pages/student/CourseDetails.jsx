...
const [playesData, setplayesData] = useState(null);
...
const togleSection=(index)=>{
  ...
  return courseData? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left '>
        ...
        <div className='absolute top-0 left-0 w-full h-section-height bg-gradient-to-b
 ...
 <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
        ...
        <div className='pt-8 text-gray-800'>
          ...
          <div className='pt-5 '>{courseData.courseContent.map((chapter,index)=>(
            <div key={index} className='border border-gray-500 bg-white mb-2 rounded'>
              <div className='flex items-center justify-between px-4 py-3
              cursor-pointer select-none' onClick={()=>togleSection(index )}>
        ...
        {/* right column */}
        <div className='course-card z-10 custom-card rounded-t
        md: rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
           {
                playesData?
                <YouTube videoId={playesData.videoId} opts={{playerVars:{autoplay:1}}}
          ...
          <div className='p-5 '>
            <div className='flex items-center gap-2'>
              ...
              <img className='w-3.5 ' 
              src={assets.time_left_clock_icon} alt="time-left" />
            ...
            <div className='flex gap-3 items-center pt-2'>
              ...
              courseData.coursePrice /100).toFixed(1)}</p>
